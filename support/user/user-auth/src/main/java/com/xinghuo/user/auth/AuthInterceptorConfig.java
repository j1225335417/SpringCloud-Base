...
import com.xinghuo.user.api.constant.SortConstant;
import com.xinghuo.user.auth.exception.AuthExceptionHandler;
 ...
 */
@Configuration
@Import({JwtProperties.class, NoAuthConfig.class, com.xinghuo.user.auth.AuthHandlerInterceptor.class, DevAuthHandlerInterceptor.class, AuthExceptionHandler.class})
public class AuthInterceptorConfig implements WebMvcConfigurer {
    ...
    @Resource
    private com.xinghuo.user.auth.AuthHandlerInterceptor authHandlerInterceptor;
