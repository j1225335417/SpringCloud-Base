...
import com.xinghuo.framework.redis.consts.Time;
//import com.xinghuo.im.api.MallImDubboService;
...
import com.xinghuo.user.core.mapper.UserMapper;
import com.xinghuo.user.core.model.dto.UserAdminQueryDTO;
import com.xinghuo.user.core.model.dto.UserInfoUpdateDTO;
...
//        Boolean result = mallImDubboService.updateImCenterUserData(updateSessionUserDTO); //临时注释
