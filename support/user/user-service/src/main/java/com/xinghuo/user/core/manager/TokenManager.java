...
import com.xinghuo.user.api.mq.UserTokenLogoutMessage;
import com.xinghuo.user.auth.JwtProperties;
import com.xinghuo.user.auth.util.JwtUtils;
...
import static com.xinghuo.user.core.model.constant.RedisKeysConstants.USER_TOKEN_MAP;
