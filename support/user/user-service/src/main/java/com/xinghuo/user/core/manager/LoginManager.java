...
//import com.xinghuo.push.api.SmsDubboService;
//import com.xinghuo.push.enums.SmsTemplateEnum;
import com.xinghuo.user.core.exception.UserExceptionCodeEnum;
import com.xinghuo.user.core.model.dto.LoginDTO;
import com.xinghuo.user.core.model.dto.PasswordLoginTobDTO;
import com.xinghuo.user.core.model.dto.VerificationCodeLoginDTO;
import com.xinghuo.user.core.model.entity.Employee;
import com.xinghuo.user.core.model.entity.User;
import com.xinghuo.user.core.model.entity.UserLoginLimit;
import com.xinghuo.user.core.model.vo.LoginSuccessVO;
import com.xinghuo.user.core.service.*;
...
import static com.xinghuo.user.core.model.constant.RedisKeysConstants.LOGIN_VERIFICATION_CODE;
import static com.xinghuo.user.core.model.constant.RedisKeysConstants.LOGIN_VERIFICATION_CODE_INTERVAL;
...
//        smsDubboService.sendSms(phone, SmsTemplateEnum.LOGIN_TEMPLATE, verificationCode);//临时注释
