...
import com.xinghuo.framework.web.transform.transformer.Transformer;
...
import static com.xinghuo.framework.common.utils.LambdaUtil.sure;
...
public class TransformUtil {
    ...
    public static void transform(Object object) {
        ...
        log.debug("转换结果：{}", JSON.toJSONString(collection));
    }
